...
public class Main {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Ingresa los comandos que desee  para mover al rover (F=HACIA DELANTE, B=HACIA ATRAS, R=GIRAR SU ORIENTACION HACIA LA DERECHA , L=GIRAR SU ORIENTACION HACIA LA IZQUIERDA) :");
